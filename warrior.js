...
selectButtonX = selectBox.querySelector(".options .playerX"),
selectButtonO = selectBox.querySelector(".options .playerO"),
...
function checkIdSign(val1,val2,val3,sign){
    if(getIdValue(val1) == sign && getIdValue(val2) == sign && getIdValue(val3) == sign){
        return true;
    }
}
